...
def main(args=None):
    ...
    # for testing
    points = [[-1.0,-0.24, 0.00],[-1.6, 1.22, 0.0],[-1.41, 4.36,-0.165],[-1.35, 3.17,-0.568],[1.9,3.04,0.57],[2.48,1.81,0.00247],[0.39,1.87,-0.207],[1.34,0.308,0.0582],[2.23,-1.78,-1],[3.27,-1.4,0.961],[1.14,-1.8,-1.0],[-0.16,-1.33,0.832]]
    # ,[-0.7, 1.42,-0.584] 3
    # [-0.464, 0.18, 0,00]
    # [1.5,-0.4,-0.069] --> 10
    # [2.23,-1.78,-1] --> 11
